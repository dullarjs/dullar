...
export default class VCalendar extends mixins(Queen).with(Props) {
  ...
  createWeekBar(): VNode {
    ...
    return h("div", { class: ["v-calendar-week-bar"] }, {
      default: () => [
        h(VFlex,
                ...
                },
                {
                  default: () => {
                    ...
                    monthItem.dates.forEach((date: CalendarDateNode) => {
                      ...
                      dateDom.push(h(VFlexItem, {
                        key: date.key,
                        class: ["v-calendar-date", ...date.className],
                        ref,
                        onClick: this.handleClick.bind(this, date)
                      }, {
                        default: () => [
                          h(VFlex, { flexDirection: "column", justifyContent: "spaceBetween" }, {
                            default: () => [
                              h(VFlexItem, { class: ["v-calendar-date-festival"] }, {
                                default: () => date.festival
                              }),
                              h(VFlexItem, { class: ["v-calendar-date-text"] }, {
                                default: () => date.day
                              }),
                              h(VFlexItem, { class: ["v-calendar-date-mark"] }, {
                                default: () => date.mark
                              })
                            ]
                          })
  ...
  createFooterArea() {
    if (this.showConfirmButton) {
      return h(VFlexItem,
        {
          class: ["v-calendar-footer"]
        },
        {
          default: () => [
            h("div", {
              class: [
                "v-calendar-confirm-button",
  ...
  setPosition(): void {
    this.$nextTick(() => {
      const el = (this.$refs.scrollPosition as VFlexItem).$el;
      const parent = (this.$refs.popup as VPopup).$el;
      ...
      const timer = setTimeout(() => {
        (this.$refs.scroller as VFlexItem).$el.scrollTop =
          getOffset(el).top -
          (this.$refs.header as VFlexItem).$el.offsetHeight -
          getOffset(parent).top;
  ...
  render() {
    return h("div", { class: ["v-calendar"] }, { default: () => [
      withDirectives(h(VPopup,
        ...
        },
        {
          default: () => [
            h(VFlex,
              {
                class: ["v-calendar-content"],
                flexDirection: "column"
              },
              {
                default: () => [
                  h(VFlexItem,
                    { class: ["v-calendar-header"], ref: "header" },
