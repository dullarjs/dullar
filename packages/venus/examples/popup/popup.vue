<template>
  <div class="spin-view">
    ...
    <v-popup v-model="popup1" position="bottom">
    ...
    <v-popup v-model="popup2" position="right" :showCloseIcon="true">
      <div class="popup-content">右侧出现遮罩</div>
    </v-popup>
    <v-popup v-model="popup7" position="left" :showCloseIcon="true">
      <div class="popup-content">左侧出现遮罩</div>
    </v-popup>
    <v-popup v-model="popup3" position="top" :showCloseIcon="true">
      <div class="popup-content">上面出现遮罩</div>
    </v-popup>
    <v-popup v-model="popup4" position="bottom" :showCloseIcon="true">
      <div class="popup-content">
        <span @click="showPopup5()">打开内层</span>
        上面出现遮罩
        <v-popup v-model="popup5" position="bottom">
          <div class="popup-content">
            内层嵌套
          </div>
        </v-popup>
    ...
    <v-popup v-model="popup6" position="middle" :showCloseIcon="true" fixed>
