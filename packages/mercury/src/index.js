...
import ScrollerBar from "./scroller-bar";
...
const components = [ActionSheet, Address, AnimationList, AnimationListItem, Autocomplete, Badge, Button, Calendar, Cascader, Category, CategoryMobile, Checkbox, Counter, DatePicker, Dialog, ElasticSearch, Field, FieldGroup, Flex, FlexItem, Form, FormItem, Iconfont, Image, Indicator, Input, Layout, Magnifier, Modal, Option, OptionGroup, Pagination, Picker, Popup, PullRefresh, Radiobox, ScrollerBar, Select, ShippingAddress, Skeleton, Slide, Spin, Sticky, Swipe, SwipeItem, Switch, TabItem, Table, Tabs, Toast, Tooltip, Tree];
const install = (Vue) => {
...
export { Autocomplete as YnAutocomplete };
...
export { Option as YnOption };
export { OptionGroup as YnOptionGroup };
...
export { ScrollerBar as YnScrollerBar };
export { Select as YnSelect };
